            ...
            <Box sx={{ width: '100%' }}>
              <div className="notranslate"> 
                <Box sx={{ borderBottom: 1, borderColor: 'divider' }}>
                  <Tabs value={this.state.tabIndex} onChange={this.handleChange} variant="scrollable" scrollButtons="auto"
                    sx={{
                      '& .MuiTabs-indicator': {
              ...
              <CustomTabPanel value={this.state.tabIndex} index={3}>
                {/* Content for tab index 2 */}
                <AccordionMenu info={directory} startIdx={28} endIdx={35} />
              </CustomTabPanel>

              <CustomTabPanel value={this.state.tabIndex} index={4}>
                {/* Content for tab index 2 */}
                <AccordionMenu info={directory} startIdx={36} endIdx={44} />
              </CustomTabPanel>

              <CustomTabPanel value={this.state.tabIndex} index={5}>
                {/* Content for tab index 2 */}
                <AccordionMenu info={directory} startIdx={45} endIdx={56} />
              </CustomTabPanel>

              <CustomTabPanel value={this.state.tabIndex} index={6}>
                {/* Content for tab index 2 */}
                <AccordionMenu info={directory} startIdx={1} endIdx={1} />
              </CustomTabPanel>

              <CustomTabPanel value={this.state.tabIndex} index={7}>
